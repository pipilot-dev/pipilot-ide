...
export type ActivityBarView = "explorer" | "search" | "source-control" | "extensions" | "debug" | "wiki" | "cloud" | "activity";
...
const ACTIVITIES: { id: ActivityBarView; icon: React.ReactNode; label: string }[] = [
  ...
  { id: "activity", icon: <Activity size={18} strokeWidth={1.6} />, label: "Agent Activity" },
